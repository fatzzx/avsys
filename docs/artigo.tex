...
\address{Curso de Ciência da Computação -- SENAI CIMATEC\\
  Av. Orlando Gomes, 1845 -- 41650-010 -- Salvador -- BA -- Brasil
  \email{\{felipe.farias, breno.moura, gabriel.aragao, nicollas.matsuo\}@senaicimatec.edu.br}
}
...
arquitetura adota o padrão de microsserviços, composta por três serviços independentes (catálogo de voos, gerenciamento de reservas
e processamento de pagamentos) orquestrados por um API Gateway NGINX. A consistência sob acesso concorrente é garantida
